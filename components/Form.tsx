    ...
    return (
        <>
            ...
            <div className="text-center mt-8">
                <button className="py-3  px-2 bg-gradient-to-r from-blue-700 via-purple-500 to-pink-500 w-2/12 rounded-lg font-semibold tracking-widest text-xl font-rubik text-white shadow-gray-500 shadow-md">Submit</button>
            </div>
        </>
    );
}
